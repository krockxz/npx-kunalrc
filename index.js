...
╚═╝░░╚═╝╚═╝  ░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚══════╝ ╚═╝╚═╝`.magenta)
    ...
    console.log()
    const spinner = createSpinner('Loading Kunal\'s details').start()
...
█▀▀ ██▄ █▀▄ ▄█ █▄█ █░▀█ █▀█ █▄▄   █▄▀ ██▄ ░█░ █▀█ █ █▄▄ ▄█`.yellow);
    ...
    const githubLink = link('btw its awesome -> ','https://github.com/krockxz');
    const websiteLInk = link('Coolest thing -> ','https://kunalrc-portfolio.vercel.app/');
    console.log(`NAME    `.green + ' - ' + 'Kunal Roy Choudhury'.cyan);
    console.log(`STATUS  `.green + ' - ' + 'Dev'.cyan);
...
console.log()
console.log('Kunal is up for hire, ready to help your company get to next heights and ofc Thanks for checking out my cli!'.magenta)
console.log()
}
